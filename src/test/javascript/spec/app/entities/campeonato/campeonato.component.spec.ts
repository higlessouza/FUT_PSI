...
import { CampeonatoComponent } from 'app/entities/campeonato/campeonato.component';
...
describe('Component Tests', () => {
  describe('Campeonato Management Component', () => {
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.campeonatoes && comp.campeonatoes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
